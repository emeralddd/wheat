/*
 * Author: Ho Ngoc Duc
 * Website: https://www.xemamlich.uhm.vn/
 */
...
function convertTo2DigitNumber(n) {
    return (n < 10 ? "0" : "") + n;
}

/* Convert a lunar date to the corresponding solar date */

function convertAmDuong(lunarDay, lunarMonth, lunarYear, lunarLeap, timeZone) {
...
class AmDuongLich {
    ...
    getNgayDuongLich() {
        const i18nDate = this.moment.format(i18next.t('calendar.gregorianDate', { lng: this.language }));
        return i18nDate[0].toUpperCase() + i18nDate.substring(1);
    }
...
exports.AmDuongLich = AmDuongLich;